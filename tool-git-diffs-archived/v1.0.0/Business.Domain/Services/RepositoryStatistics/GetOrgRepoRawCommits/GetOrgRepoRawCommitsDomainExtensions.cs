...
{
  public static (string FromBranchOrTag, string ToBranchOrTag) GetGitReference(this IGetRepoCommitsDomainRequest.Repository repository, GetOrgRepoRawCommitsDomainRequest domainRequest)
  {
